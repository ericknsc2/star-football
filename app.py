...
# Inicializar o estado da sessão para controlar a carreira
if "carreira_iniciada" not in st.session_state:
  st.session_state.carreira_iniciada = False
...
# --- TELA 2: PAINEL PRINCIPAL DO JOGO (MENU ESTILO CARREIRA) ---
else:
  jogador = st.session_state.jogador
  ...
  # --- ABA 3: SIMULAÇÃO DE PARTIDA (MOMENTOS DECISIVOS) ---
  with aba_partida:
